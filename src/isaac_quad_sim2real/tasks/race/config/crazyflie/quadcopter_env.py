...
class QuadcopterEnv(DirectRLEnv):
    ...
    def _setup_scene(self):
        ...
        tracks = {
            ...
            # Phase 2 Stage 1: Circle Track (from ESE651 Phase 2-3 handout).
            # Four gates forming a square loop; gate 2 sits at z=1.75 so the
            # drone must climb 1m between gates 1->2 and descend 1m between
            # gates 2->3 (not a planar circle).
            'circle': [
